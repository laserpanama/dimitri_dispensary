...
export default function Menu() {
  ...
  // Optimization: Use usePersistFn to provide a stable reference for the handler.
  // When combined with React.memo on ProductCard, this prevents unnecessary re-renders of all product cards
  // when the Menu component re-renders (e.g., when switching categories).
