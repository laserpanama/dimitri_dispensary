...
export default function Menu() {
  ...
  // Optimization: Use usePersistFn to provide a stable reference for the memoized ProductCard component.
  // This prevents all ProductCards from re-rendering when the Menu component re-renders.
