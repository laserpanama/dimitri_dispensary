...
export default function Menu() {
  ...
  /**
   * handleAddToCart callback to manage cart logic in localStorage.
   * Optimization: Wrapped in useCallback to provide a stable reference to ProductCard,
   * enabling React.memo to prevent O(N) re-renders when category selection changes.
   */
