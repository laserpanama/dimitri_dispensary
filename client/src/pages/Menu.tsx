...
export default function Menu() {
  ...
  // Optimization: usePersistFn provides a stable function reference for the event handler.
  // This prevents ProductCard from re-rendering when the Menu state (e.g., selectedCategory) changes.
