...
export default function Cart() {
  ...
  // Derived state: Create product lookup map from fetched products.
  // Using useMemo eliminates an extra render cycle caused by useEffect + useState.
  ...
  // Optimization: Memoize total calculation to prevent redundant processing on re-renders.
  const total = useMemo(() => {
