...
export default function Cart() {
  ...
  // Optimization: Use useMemo for product lookup instead of useEffect + useState.
  // This avoids an extra render cycle when fetchedProducts changes.
  ...
  // Optimization: Memoize total calculation to prevent redundant processing on every render.
  // This is especially beneficial when the user is typing in the deliveryAddress field.
  const total = useMemo(() => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        // Optimization: Use SPA navigation instead of full page reload.
        setLocation("/orders");
      }, 1000);
    } catch (error) {
