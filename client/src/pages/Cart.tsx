...
export default function Cart() {
  ...
  // This avoids an extra state update and render cycle compared to useState + useEffect.
  ...
  // Optimization: Memoize total price calculation to avoid redundant iterations on every render.
  const total = useMemo(() => {
