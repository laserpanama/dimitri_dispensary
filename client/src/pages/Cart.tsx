...
export default function Cart() {
  ...
  // Optimization: Derived product lookup using useMemo to avoid extra render cycle from state/effect.
  ...
  // Optimization: Memoize total calculation to prevent redundant calculations on every re-render (e.g. while typing address).
  const total = useMemo(() => {
