...
export default function Cart() {
  ...
  // Optimization: Derive product lookup directly using useMemo.
  // This eliminates the extra render cycle previously caused by state synchronization in useEffect.
  ...
  // This prevents redundant O(N) calculations on every render, especially when the cart volume increases.
  const total = useMemo(() => {
