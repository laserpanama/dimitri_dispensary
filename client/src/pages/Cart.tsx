                      ...
                      <div className="flex items-center border border-green-500/50 rounded-lg">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-l-lg"
                              aria-label={
                                item.quantity === 1
                                  ? t("cart.removeItem")
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              onClick={() => handleUpdateQuantity(item.productId, item.quantity + 1)}
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-r-lg"
