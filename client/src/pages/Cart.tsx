...
export default function Cart() {
  ...
  // Optimization: Use useMemo for product lookup to eliminate an extra render cycle from useEffect
  ...
  // Optimization: Memoize total calculation to avoid unnecessary re-computations
  const total = useMemo(() => {
