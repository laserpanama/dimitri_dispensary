...
export default function Cart() {
  ...
  // Optimization: Use useMemo to create a product lookup map directly from fetchedProducts.
  // This eliminates the need for an extra useState and useEffect, reducing render cycles.
  ...
  // Optimization: Memoize the total calculation to avoid unnecessary recalculations
  // during every render if the cart items or product data haven't changed.
  const total = useMemo(() => {
