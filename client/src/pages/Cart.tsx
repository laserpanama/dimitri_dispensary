...
export default function Cart() {
  ...
  // Optimization: Derive product lookup directly from fetched data to avoid redundant state and extra render cycles.
  ...
  // Optimization: Memoize total price to prevent recalculation when unrelated state (like address) changes.
  const total = useMemo(() => {
