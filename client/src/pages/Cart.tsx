...
export default function Cart() {
  ...
  // Optimization: Create product lookup map using useMemo instead of useEffect + useState.
  // This avoids an extra render cycle when fetchedProducts data arrives.
  ...
  // Optimization: Memoize the total calculation to avoid recomputing on every render
  // (e.g. when the user types in the delivery address field).
  const total = useMemo(() => {
