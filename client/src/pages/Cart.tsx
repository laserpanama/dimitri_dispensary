                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center border border-green-500/50 rounded-lg overflow-hidden">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-green-500 transition-all"
                        ...
                        <span
                          className="px-4 py-2 text-white font-semibold min-w-[3rem] text-center"
                          aria-live="polite"
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className="p-2 text-red-400 hover:bg-red-500/20 rounded-lg transition-all outline-none focus-visible:ring-2 focus-visible:ring-red-500"
                            aria-label={`${t("common.remove")} ${product.name} ${t("common.from")} ${t("common.cart")}`}
                          >
