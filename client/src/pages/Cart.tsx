      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {cartItems.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-300 mb-8">{t("cart.continueShopping")}</p>
            <Link href="/menu">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center border border-green-500/50 rounded-lg">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-l-lg transition-all"
                              aria-label={
                                item.quantity === 1
                                  ? t("cart.removeItem")
                        ...
                        <span className="px-4 py-2 text-white font-semibold tabular-nums">
                          {item.quantity}
                        </span>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-r-lg transition-all"
              ...
              {fulfillmentType === "delivery" && (
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-slate-800/50 border border-green-500/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all"
                    rows={3}
                  />
                </div>
              )}
