...
export default function Cart() {
  ...
  // Optimization: Derive product lookup map directly from fetched data using useMemo.
  // This eliminates an extra render cycle caused by useEffect + useState.
  ...
  // Optimization: Memoize the total calculation to avoid recalculating on every render.
  // This ensures the reduce operation only runs when cart items or product data changes.
  const total = useMemo(() => {
