                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center border border-green-500/50 rounded-lg overflow-hidden">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 transition-colors focus-visible:bg-green-500/20 focus-visible:outline-none"
                              aria-label={t("cart.decreaseQuantity", { name: product.name })}
                            >
                              −
                            </button>
                          </TooltipTrigger>
                          <TooltipContent>{t("cart.decrease")}</TooltipContent>
                        </Tooltip>
                        <span
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>{t("cart.increase")}</TooltipContent>
                        </Tooltip>
                      </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className="p-2 text-red-400 hover:bg-red-500/20 rounded-lg transition-colors focus-visible:bg-red-500/20 focus-visible:outline-none"
