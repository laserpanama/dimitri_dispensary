...
export default function Cart() {
  ...
  // Stabilization: Using a sorted join key string ensures the array reference remains stable when only item quantities change.
  ...
  // Optimization: Use useMemo to derive the product lookup table directly from fetchedProducts.
  // This eliminates an extra render cycle caused by updating state via useEffect.
  ...
  // Optimization: Memoize the total price calculation to prevent expensive recalculations
  // during unrelated state updates (e.g., when typing in the delivery address field).
  const total = useMemo(() => {
