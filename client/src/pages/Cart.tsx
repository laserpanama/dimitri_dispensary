                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center border border-green-500/50 rounded-lg">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-green-500 transition-colors rounded-l-lg"
                        ...
                        <span className="px-4 py-2 text-white font-semibold border-x border-green-500/50">
                          {item.quantity}
                        </span>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              className="px-3 py-2 text-green-400 hover:bg-green-500/20 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-green-500 transition-colors rounded-r-lg"
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className="p-2 text-red-400 hover:bg-red-500/20 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-500"
