...
export const appRouter = router({
  ...
  products: router({
    ...
    getByIds: publicProcedure
      .input(z.object({ ids: z.array(z.number()).max(50, "Maximum 50 products allowed per request") }))
      .query(async ({ input }) => {
      ...
      .input(
        z.object({
          items: z
            ...
            .max(20, "Maximum 20 items allowed per order"),
          fulfillmentType: z.enum(["pickup", "delivery"]),
          deliveryAddress: z.string().max(1000, "Address is too long").optional(),
        })
      )
